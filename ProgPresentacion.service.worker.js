...
/** @type {string} */
const CACHE_VERSION = '1771412842|7243303092';
/** @type {string} */
const CACHE_PREFIX = 'Grupo Creando-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ProgPresentacion.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ProgPresentacion.html","ProgPresentacion.js","ProgPresentacion.offline.html","ProgPresentacion.icon.png","ProgPresentacion.apple-touch-icon.png","ProgPresentacion.audio.worklet.js","ProgPresentacion.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ProgPresentacion.wasm","ProgPresentacion.pck","ProgPresentacion.side.wasm"];
